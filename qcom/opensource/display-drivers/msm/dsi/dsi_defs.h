...
/* Add these to enum dsi_cmd_set_type */
        DSI_CMD_SET_MI_LOCAL_HBM_NORMAL_WHITE_1000NIT_PRE,
        DSI_CMD_SET_MI_LOCAL_HBM_OFF_TO_NORMAL_EM_CYCLE_16PULSE,
        ...
        DSI_CMD_SET_MI_DIMMING_8FRAME,
        DSI_CMD_SET_MI_DIMMING_4FRAME,
        DSI_CMD_SET_MI_SWITCH_PAGE_UPDATE,
        DSI_CMD_SET_MI_LOCAL_HBM_NORMAL_GREEN_500NIT,
        DSI_CMD_SET_MI_LOCAL_HBM_NORMAL_GREEN_500NIT_UPDATE,
        ...
        DSI_CMD_SET_MI_DOZE_HBM_NOLP_UPDATE,
        DSI_CMD_SET_MI_DOZE_LBM_NOLP,
        DSI_CMD_SET_MI_DOZE_LBM_NOLP_UPDATE,
        DSI_CMD_SET_MI_LOCAL_HBM_HLPM_WHITE_1000NIT_B2_UPDATE,
        DSI_CMD_SET_MI_LOCAL_HBM_HLPM_WHITE_110NIT_B2_UPDATE,
        DSI_CMD_SET_MI_DOZE_PARAM_READ,
        DS I_CMD_SET_MI_DOZE_PARAM_READ_END,
        DSI_CMD_SET_MI_HBM_FOD_ON,
        DSI_CMD_SET_MI_HBM_FOD_ON_UPDATE,
        DSI_CMD_SET_MI_HBM_FOD_OFF,
        DSI_CMD_SET_MI_HBM_FOD_OFF_UPDATE,
        DSI_CMD_SET_MI_LOCAL_HBM_OFF_TO_HBM,
        DSI_CMD_SET_MI_LOCAL_HBM_OFF_TO_HBM_UPDATE,
        DSI_CMD_SET_MI_LOCAL_HBM_OFF_TO_NORMAL,
        DSI_CMD_SET_MI_LOCAL_HBM_OFF_TO_NORMAL_UPDATE,
        DSI_CMD_SET_UHBM_ENTER,
        DSI_CMD_SET_UHBM_ENTER_UPDATE,
...
struct dsi_display_mode_priv_info {
	struct dsi_panel_cmd_set cmd_sets[DSI_CMD_SET_MAX];
        ...
        u32 flat_on_gamma;
        u32 flat_off_gamma;
        u32 flat_on_lhbm_gamma;
        u32 flat_off_lhbm_gamma;
