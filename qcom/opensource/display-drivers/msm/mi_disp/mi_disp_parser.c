...
static void mi_dsi_panel_parse_lhbm_config(struct dsi_panel *panel)
{
	...
	mi_cfg->need_aod_enter_set_backlight=
			utils->read_bool(utils->data, "mi,need_aod_enter_set_backlight");
	if (mi_cfg->need_aod_enter_set_backlight)
		DISP_INFO("mi,need_aod_enter_set_backlight\n");

	mi_cfg->need_aod_exit_set_backlight=
			utils->read_bool(utils->data, "mi,need_aod_exit_set_backlight");
	if (mi_cfg->need_aod_exit_set_backlight)
		DISP_INFO("mi,need_aod_exit_set_backlight\n");
