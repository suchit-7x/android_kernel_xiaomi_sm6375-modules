...
const char *dsi_phy_rw_str[MI_DISP_MAX] = {
	[MI_DISP_PRIMARY] = "dsi0_phy_rw",
	[MI_DISP_SECONDARY] = "dsi1_phy_rw",
};

const char *dsi_porch_rw_str[MI_DISP_MAX] = {
	[MI_DISP_PRIMARY] = "dsi0_porch_rw",
	[MI_DISP_SECONDARY] = "dsi1_porch_rw",
};

const char *pps_rw_str[MI_DISP_MAX] = {
	[MI_DISP_PRIMARY] = "pps0_rw",
	[MI_DISP_SECONDARY] = "pps1_rw",
};

struct disp_procfs {
	struct proc_dir_entry *mipi_rw_proc[MI_DISP_MAX];
	struct proc_dir_entry *tx_cmd_set[MI_DISP_MAX];
	struct proc_dir_entry *dsi_phy_rw_proc[MI_DISP_MAX];
	struct proc_dir_entry *dsi_porch_rw_proc[MI_DISP_MAX];
	struct proc_dir_entry *pps_rw_proc[MI_DISP_MAX];
};
